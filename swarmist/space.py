...
def minimize(
    ...
    return SpaceBuilder(f, Bounds(lbound, ubound), dimensions, True)
...
def maximize(
    ...
    return SpaceBuilder(f, Bounds(lbound, ubound), dimensions, False)

class SpaceBuilder:
    def __init__(self, fitness_function: FitnessFunction, bounds: Bounds, dimensions: int, minimize: bool = True):
